...
REFS = {
    "abstract": ["msor-manuscript-judgment.md", "msor-word-choice-collocations.md", "msor-sentence-craft.md", "msor-natural-prose.md", "msor-micro-phrasing.md", "management-science-whole-paper-storycraft.md", "section-architecture.md", "msor-paper-craft.md"],
    ...
    "introduction": ["msor-manuscript-judgment.md", "msor-word-choice-collocations.md", "msor-sentence-craft.md", "msor-natural-prose.md", "msor-micro-phrasing.md", "management-science-whole-paper-storycraft.md", "section-architecture.md", "msor-paper-craft.md"],
    ...
    "model": ["msor-word-choice-collocations.md", "msor-sentence-craft.md", "msor-natural-prose.md", "management-science-model-proof-equation-layout.md", "math-model-main-appendix-craft.md", "paper-appendix-paired-patterns.md", "msor-language-model-math.md"],
    "results": ["msor-manuscript-judgment.md", "msor-word-choice-collocations.md", "msor-sentence-craft.md", "msor-natural-prose.md", "msor-micro-phrasing.md", "management-science-model-proof-equation-layout.md", "math-model-main-appendix-craft.md", "paper-appendix-paired-patterns.md", "msor-language-model-math.md"],
    "proof": ["msor-word-choice-collocations.md", "msor-sentence-craft.md", "msor-natural-prose.md", "management-science-model-proof-equation-layout.md", "math-model-main-appendix-craft.md", "paper-appendix-paired-patterns.md", "math-and-proof-style.md", "math-proof-writing for complete proofs", "theory-proof-workbench for missing proofs"],
